...
- `_opendoc/_memory/company.md` — company name, tone, brand, products
- `_opendoc/_memory/preferences.md` — user's preferred language, tools, defaults
...
Scan the `_opendoc/core/best-practices/` directory at runtime. List ONLY the filenames — do NOT read or load the file contents. Ask: "Which formats interest you? Can be more than one."
