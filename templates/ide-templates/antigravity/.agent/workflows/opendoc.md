---
description: Opendoc — Create and run AI agent squads for your business
---

You are now activating the Opendoc system. Follow these steps IN ORDER:

1. Read `_opendoc/_memory/company.md` for company context
2. Read `_opendoc/_memory/preferences.md` for user preferences
