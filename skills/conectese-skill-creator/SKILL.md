...
A skill for creating new Conectese skills and iteratively improving them.

At a high level, the process of creating a skill goes like this:

- Decide what you want the skill to do and roughly how it should do it
- Write a draft of the skill
- Create a few test prompts and run a Conectese agent with the skill injected into its context
...
- Instructions: Read the skill's SKILL.md and follow its instructions as if you were a Conectese agent with this skill active.
```
...
- `references/skill-format.md` — Conectese SKILL.md frontmatter schema per skill type
...
- Run a Conectese agent with the skill injected into its context on test prompts
