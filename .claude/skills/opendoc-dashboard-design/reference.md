# Opendoc Dashboard Design — Reference Guide

Reference material for the opendoc-dashboard-design skill. Consult this file during implementation phases when you need asset catalogs, code examples, or detailed technical guidance.
