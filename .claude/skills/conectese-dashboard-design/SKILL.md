---
name: conectese-dashboard-design
description: Use when creating, modifying, or designing 2D virtual office scenes for the conectese dashboard — room layouts, furniture placement, avatar integration, environment design, or any visual improvement. Also use when the dashboard looks empty, flat, lifeless, or lacks personality.
---

# Conectese Dashboard Design — Visual Office Workflow

Design and improve the conectese dashboard's 2D virtual office through a structured workflow with visual verification. Every change is screenshot-verified before completion.
...
- Instruction: read `.claude/skills/conectese-dashboard-design/reference.md` if you need the asset catalog or code examples
...
- **Consult reference.md** (`.claude/skills/conectese-dashboard-design/reference.md`) for the full asset catalog, code examples, and detailed technical guidance during implementation
