...
skills:
  - conectese-scraper
  - document-analyzer
  - direito-me-dico-e-da-sa-de-toolbox
---
...
* Se for necessário buscar uma norma ou acórdão específico do seu nicho de atuação: Chame `direito-me-dico-e-da-sa-de-toolbox` (ou utilize o `conectese-scraper` passando o contexto da sua área).
