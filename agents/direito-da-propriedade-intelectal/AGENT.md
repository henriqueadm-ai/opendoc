...
skills:
  - conectese-scraper
  - document-analyzer
  - direito-da-propriedade-intelectal-toolbox
---
...
* Se for necessário buscar uma norma ou acórdão específico do seu nicho de atuação: Chame `direito-da-propriedade-intelectal-toolbox` (ou utilize o `conectese-scraper` passando o contexto da sua área).
