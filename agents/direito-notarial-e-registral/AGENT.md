...
skills:
  - conectese-scraper
  - document-analyzer
  - direito-notarial-e-registral-toolbox
---
...
* Se for necessário buscar uma norma ou acórdão específico do seu nicho de atuação: Chame `direito-notarial-e-registral-toolbox` (ou utilize o `conectese-scraper` passando o contexto da sua área).
