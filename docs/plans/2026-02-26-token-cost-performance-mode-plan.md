...
**Files:**
- Modify: `_conectese/core/architect.agent.yaml:101-113`
...
Replace all other occurrences of `Rápido` with `Econômico` in `_conectese/core/architect.agent.yaml`:
...
**Files:**
- Modify: `templates/_conectese/core/architect.agent.yaml:101-113`
...
**Files:**
- Modify: `_conectese/core/prompts/analyst.prompt.md:46`
- Modify: `_conectese/core/prompts/reviewer.prompt.md:45`
- Modify: `templates/_conectese/core/prompts/analyst.prompt.md:46`
- Modify: `templates/_conectese/core/prompts/reviewer.prompt.md:45`
...
```bash
git add _conectese/core/prompts/analyst.prompt.md _conectese/core/prompts/reviewer.prompt.md templates/_conectese/core/prompts/analyst.prompt.md templates/_conectese/core/prompts/reviewer.prompt.md
